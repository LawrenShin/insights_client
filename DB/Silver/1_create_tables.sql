...
INSERT INTO PropertyMetadata(
	...
	('Company','roles',NULL,NULL,7,False,True,NULL,'Role',NULL,NULL,1),
	('Company','legalName','Legal Name of company',NULL,0,False,True,NULL,NULL,NULL,NULL,2),
	('Company','addresses','Addresses',NULL,7,False,True,NULL,'Address',NULL,NULL,3),
	...
	('Company','keyFinancialsMetrics','Key Financials Metrics',NULL,8,False,True,NULL,'CompanyKeyFinancialsMetrics',NULL,NULL,6),
	('Company','diMetrics','DI Metrics',NULL,8,False,True,NULL,'CompanyDIMetrics',NULL,NULL,7),
	('Company','genderMetrics','Gender Metrics',NULL,8,False,True,NULL,'CompanyGenderMetrics',NULL,NULL,8),
	...
	('Address','city','City',NULL,0,True,True,NULL,NULL,NULL,NULL,22),
	('Address','state','State',NULL,0,True,True,NULL,NULL,NULL,NULL,23),
	('Address','country','Country',NULL,6,True,True,'countries',NULL,NULL,NULL,24),
	('Address','isoCode',NULL,NULL,0,True,False,NULL,NULL,NULL,NULL,25),
	('CompanyIndustry','industry','Industry name',NULL,6,False,True,'industries',NULL,NULL,NULL,26),
	('CompanyIndustry','industryCodeType','Industry code type',NULL,6,False,True,'industryCodes',NULL,NULL,NULL,27),
	('CompanyIndustry','industryCode','Industry code',NULL,2,True,True,'industryCodes',NULL,'0','999999',28),
	('CompanyIndustry','tradeDescription','Description of a trade',NULL,0,True,True,NULL,NULL,NULL,NULL,29),
	('CompanyIndustry','isPrimary','Is this trade primary for a company?',NULL,1,True,True,NULL,NULL,NULL,NULL,30),
	('CompanyKeyFinancialsMetrics','employees','Number of Employees',NULL,2,True,True,NULL,NULL,'0',NULL,31),
	('CompanyKeyFinancialsMetrics','operatingRevenue','Operating Revenue, in $',NULL,2,True,True,NULL,NULL,'0',NULL,32),
	('CompanyGenderMetrics','genderRatioSenior','Senior Management female Ratio','Group consists of C-level, ExecutiveDirectors/ExecutiveVicePresidents, 	(SeniorDirectors/SeniorVicePresidents, VicePresidents,% female',5,True,True,NULL,NULL,'0','100',33),
	('CompanyGenderMetrics','genderRatioMiddle','Middle Management female Ratio','Group consists of Directors, Senior Managers,  Managers and Team Leads, % female',5,True,True,NULL,NULL,'0','100',34),
	('CompanyGenderMetrics','genderRatioAll','Percentage of female employees','Group consists of all FTE and Part time employee, % female',5,True,True,NULL,NULL,'0','100',35),
	('CompanyGenderMetrics','genderPayGap','Gender Pay Gap in percentage (female)','% of female gap to men',5,True,True,NULL,NULL,'0','100',36),
	('CompanyGenderMetrics','genderRatioBoard','Board female Ratio','% of female gap to men',5,True,True,NULL,NULL,'0','100',37),
	('CompanyGenderMetrics','genderRatioExecutive','Executives female Ratio','% of female gap to men',5,True,True,NULL,NULL,'0','100',38),
	('CompanyRaceMetrics','raceRatioExececutive','Ratio of visible minority in Executives',NULL,5,True,True,NULL,NULL,'0','100',39),
	('CompanyRaceMetrics','raceRatioBoard','Ratio of visible minority in Board',NULL,5,True,True,NULL,NULL,'0','100',40),
	('CompanyRaceMetrics','raceRatioSenior','Ratio of visible minority in Senior Management','Group consists of C-level, ExecutiveDirectors/ExecutiveVicePresidents,  SeniorDirectors/SeniorVicePresidents, VicePresidents, % minority',5,True,True,NULL,NULL,'0','100',41),
	('CompanyRaceMetrics','raceRatioMiddle','Ratio of visible minority in Middle Management','Group consists of Directors, Senior Managers,  Managers and Team Leads, % minority',5,True,True,NULL,NULL,'0','100',42),
	('CompanyRaceMetrics','raceRatioAll','Ratio of visible minority in all employees','Group consists of all FTE and Part time employee, % minority',5,True,True,NULL,NULL,'0','100',43),
	('CompanyJobMetrics','totalHours','Total hours worked (FTE and contractors)',NULL,2,True,True,NULL,NULL,'0',NULL,44),
	('CompanyJobMetrics','employTurnoverTotal','Total employee turnover rate',NULL,5,True,True,NULL,NULL,'0','100',45),
	('CompanyJobMetrics','employTurnoverVoluntary','Voluntary employee turnover rate',NULL,5,True,True,NULL,NULL,'0','100',46),
	('CompanyJobMetrics','employTurnoverFired','Unvoluntary employee turnover rate',NULL,5,True,True,NULL,NULL,'0','100',47),
	('CompanyJobMetrics','employTraining','Does company offer training and development?',NULL,1,True,True,NULL,NULL,NULL,NULL,48),
	('CompanyDIMetrics','socialProgram','Does company have social impact program(s) in place?',NULL,1,True,True,NULL,NULL,NULL,NULL,49),
	('CompanyDIMetrics','retaliation','Does company have no retaliation policy in place?',NULL,1,True,True,NULL,NULL,NULL,NULL,50),
	('CompanyDIMetrics','supplySpend','Percentage of company''s supplier spending is with D&I suppliers?',NULL,5,True,True,NULL,NULL,'0','100',51),
	('CompanyDIMetrics','valueDISupplySpend','Value of company''s supplier spending with D&I suppliers?',NULL,3,True,True,NULL,NULL,NULL,NULL,52),
	('CompanyDIMetrics','diSupplySpendRevenueRatio','DI supply spend to revenue ratio',NULL,5,True,True,NULL,NULL,'0','100',53),
	('CompanyDIMetrics','mentorProgram','Does company have talent program in place for advancing minority groups',NULL,1,True,True,NULL,NULL,NULL,NULL,54),
	('CompanyDIMetrics','socialEvents','Does company have social events with attendance from different departments?',NULL,1,True,True,NULL,NULL,NULL,NULL,55),
	('CompanyDIMetrics','employEngagement','Does company meassure peoples Engagement/Satisfaction or similar employee metric?',NULL,1,True,True,NULL,NULL,NULL,NULL,56),
	('CompanyDIMetrics','employSatisfactionSurvey','Engagement/Satisfaction Survey - score',NULL,3,True,True,NULL,NULL,'0','100',57),
	('CompanyDIMetrics','employSurveyResponseRate','Engagement/Satisfaction Survey - response rate',NULL,5,True,True,NULL,NULL,'0','100',58),
	('CompanyDIMetrics','diPolicyEstablished','Does company have D&I policy established?',NULL,1,True,True,NULL,NULL,NULL,NULL,59),
	('CompanyDIMetrics','diPublicAvailable','Does company make any D&I policy publicly available?',NULL,1,True,True,NULL,NULL,NULL,NULL,60),
	('CompanyDIMetrics','diWebsite','Does D&I have a specific place on company''s website?',NULL,1,True,True,NULL,NULL,NULL,NULL,61),
	('CompanyDIMetrics','diPosition','Is Head of D&I an established position?',NULL,1,True,True,NULL,NULL,NULL,NULL,62),
	('CompanyDIMetrics','diFTEPosition','Is Head of D&I a sole position?',NULL,1,True,True,NULL,NULL,NULL,NULL,63),
	('CompanyDIMetrics','diPositionExecutive','Is Head of D&I part of Executive team?',NULL,1,True,True,NULL,NULL,NULL,NULL,64),
	('CompanyHealthMetrics','fatalities','Number of Fatalities in a year',NULL,2,True,True,NULL,NULL,'0',NULL,65),
	('CompanyHealthMetrics','sickAbsence','Sickness absence - percentage',NULL,5,True,True,NULL,NULL,'0','100',66),
	('CompanyHealthMetrics','healthTRI','Total recordable injuries (TRIs)',NULL,2,True,True,NULL,NULL,'0',NULL,67),
	('CompanyHealthMetrics','healthTRIR','Total recordable injury rate (TRIR)','TotalHours/HealthTRI',2,True,True,NULL,NULL,'0',NULL,68),
	('Person','name','Name of a person',NULL,0,True,True,NULL,NULL,NULL,NULL,69),
	('Person','roles','Board/Executive roles',NULL,7,False,True,NULL,'Role',NULL,NULL,70),
	('Person','yearOfBirth','Year of birth',NULL,2,True,True,NULL,NULL,'1900',NULL,71),
	('Person','gender','Gender of a person',NULL,6,True,True,'Genders',NULL,NULL,NULL,72),
	('Person','race','Race/Ethnicity of a person',NULL,6,True,True,'Races',NULL,NULL,NULL,73),
	('Person','religion','Religion of a person',NULL,6,True,True,'Religions',NULL,NULL,NULL,74),
	('Person','married','Is person married?',NULL,1,True,True,NULL,NULL,NULL,NULL,75),
	('Person','kids','Does person have kids?',NULL,1,True,True,NULL,NULL,NULL,NULL,76),
	('Person','nationalities','Person Nationalities',NULL,7,False,True,NULL,'PersonNationality',NULL,NULL,77),
	('Person','highEducation','Highest education level of a person',NULL,6,True,True,'educationLevels',NULL,NULL,NULL,78),
	('Person','educationSubject','Educational subject of a person',NULL,6,True,True,'educationSubjects',NULL,NULL,NULL,79),
	('Person','educationInstitute','Educational Institute of a person',NULL,0,True,True,NULL,NULL,NULL,NULL,80),
	('Person','sexuality','Person''s sexuality',NULL,0,True,True,NULL,NULL,NULL,NULL,81),
	('Person','visibleDisability','Does person have visible disability?',NULL,0,True,True,NULL,NULL,NULL,NULL,82),
	('Person','urban','Did person grow up in Urban location?',NULL,1,True,True,NULL,NULL,NULL,NULL,83),
	('PersonNationality','country','Country',NULL,6,False,True,'Countries',NULL,NULL,NULL,84),
	('PersonNationality','isoCode',NULL,NULL,0,True,False,NULL,NULL,NULL,NULL,85),
	('Role','roleType','Role type',NULL,6,False,True,'RoleTypes',NULL,NULL,NULL,86),
	('Role','title','Title',NULL,0,False,True,NULL,NULL,NULL,NULL,87),
	('Role','baseSalary','Base salary',NULL,3,True,True,NULL,NULL,'0',NULL,88),
	('Role','otherIncentives','Other incentives',NULL,3,True,True,NULL,NULL,'0',NULL,89),
	('Role','jobTenure','Job tenure',NULL,2,True,True,NULL,NULL,'0',NULL,90),
	('Role','companyId',NULL,NULL,6,False,True,'companies',NULL,NULL,NULL,91),
	('Role','personId',NULL,NULL,6,False,True,'people',NULL,NULL,NULL,92);
...
(
	...
	GenderRatioExecutive FLOAT DEFAULT NULL,
	EffectiveFrom TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP
);
...
(
	...
	CompanyId INT NOT NULL REFERENCES Companies(Id) ON DELETE CASCADE,
	IndustryId INT NOT NULL REFERENCES Industries(Id),
	IndustryCodeType INT REFERENCES IndustryCodes(Id) NOT NULL,
	IndustryCode INT DEFAULT NULL,
...
(
	...
	YearOfBirth SMALLINT NULL DEFAULT NULL,
