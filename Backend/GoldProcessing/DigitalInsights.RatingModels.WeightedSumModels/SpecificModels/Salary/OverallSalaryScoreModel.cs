...
namespace DigitalInsights.RatingModels.WeightedSumModels.SpecificModels.Salary
{
    ...
    {
        public override RatingType ScoreType => RatingType.SalaryScore;
        ...
        public override KeyValuePair<RatingType, double> CalculateScore(Company company)
        {
            ...
            return new KeyValuePair<RatingType, double>(ScoreType, salarySum < countryAvgSalary * 2 * count ? 100 : 0);
        }
    }
}